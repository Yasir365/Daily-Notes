...
const sendEmail = async (email, otp) => {
    ...
    let mailOptions = {
        from: `Ticketing System Team 👻 ${process.env.EMAIL} `,
        to: email,
        subject: 'Ticketing System Two-Factor Authentication',
        html: `
...
module.exports = { login, register, verifyOTP, forgetPassword, resetPassword, changePassword };
